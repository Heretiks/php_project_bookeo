    ...
    <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a href="index.php?controller=book&action=list" class="nav-link px-2 <?= NavigationTools::addActiveClass('book', 'list') ?>">Liste des livres</a>
                </li>
                ...
                <?php } ?>
                <!-- Pour rejoindre la page de gestion des auteurs : -->
                <?php if (User::isLogged() && User::isAdmin()) { ?>
                    <li><a href="index.php?controller=author&action=list" class="nav-link px-2 <?= NavigationTools::addActiveClass('book', 'add') ?>">Modifier les auteurs</a></li>
                <?php } ?>
            </ul>
