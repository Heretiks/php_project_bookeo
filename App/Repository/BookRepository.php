...
class BookRepository extends Repository
{
    ...
    {
        // commencer par une requête simple puis gérer la pagination
        ...
        $query->execute();
        $results = $query->fetchAll($this->pdo::FETCH_CLASS, Book::class);
        
        $books = [];

        // faire une boucle sur le tableau de livre pour hydrater et stocker les objets livres avec Book::createAndHydrate
